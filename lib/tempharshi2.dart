...
class CreatePdfWidget extends StatelessWidget {
  ...
  CreatePdfWidget({required this.newVoiceText});
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      home: CreatePdfStatefulWidget(myText: newVoiceText),
    );
  }
}
...
class CreatePdfStatefulWidget extends StatefulWidget {
  ...
  CreatePdfStatefulWidget({required this.myText});
